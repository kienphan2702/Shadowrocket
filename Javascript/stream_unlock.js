    ...
    await inner_check()
      .then((code) => {
        if (code === 'Not Available') {
          ...
          youtube_check_result += 'unlocked: ' +`${getFlagEmoji(code)} ` 
        }
      })
      .catch((error) => {
        youtube_check_result += 'failed, please refresh🔄'
      })
  ...
  async function check_netflix() {
    ...
    await inner_check(81215567)
      .then((code) => {
        ...
        netflix_check_result += 'unlocked: '  +`${getFlagEmoji(code)} ` 
      ...
      .then((code) => {
        ...
        netflix_check_result += 'drama only: ' + `${getFlagEmoji(code)} ` 
        return Promise.reject('BreakSignal')
      })
      .catch((error) => {
        ...
        netflix_check_result += 'failed, please refresh🔄'
      })
